...
/* global ucfBandsScreenReaderText */
...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  if (parentMenuItemToggled) {
    ...
    toggleButton.setAttribute('aria-label', ucfBandsScreenReaderText.expand); // Make sure all children are closed.
    ...
    toggleButton.setAttribute('aria-label', ucfBandsScreenReaderText.collapse);
  }
}
/**
...
function getDropdownButton() {
  ...
  dropdownButton.setAttribute('aria-label', ucfBandsScreenReaderText.expand);
