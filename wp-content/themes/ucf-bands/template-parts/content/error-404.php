...
<section class="error">
	...
	<div class="page-content">
		...
		<div class="widget widget_categories">
			<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'ucf-bands' ); ?></h2>
			<ul>
			<?php
			wp_list_categories(
				[
		...
		$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'ucf-bands' ), convert_smilies( ':)' ) ) . '</p>';
